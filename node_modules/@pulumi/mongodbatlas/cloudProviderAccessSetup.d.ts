...
export declare class CloudProviderAccessSetup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudProviderAccessSetupState, opts?: pulumi.CustomResourceOptions): CloudProviderAccessSetup;
    /**
