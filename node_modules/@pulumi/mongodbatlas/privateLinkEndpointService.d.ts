...
export declare class PrivateLinkEndpointService extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateLinkEndpointServiceState, opts?: pulumi.CustomResourceOptions): PrivateLinkEndpointService;
    /**
     ...
     */
    static isInstance(obj: any): obj is PrivateLinkEndpointService;
    /**
     * Status of the interface endpoint for AWS.
     * Returns one of the following values:
     */
    readonly awsConnectionStatus: pulumi.Output<string>;
    /**
     * Status of the interface endpoint for AZURE.
     * Returns one of the following values:
     */
    readonly azureStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly privateEndpointResourceId: pulumi.Output<string>;
    /**
