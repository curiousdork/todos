 ...
 * ```
 */
export declare class OnlineArchive extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OnlineArchiveState, opts?: pulumi.CustomResourceOptions): OnlineArchive;
    /**
     * Returns true if the given object is an instance of OnlineArchive.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OnlineArchive;
    /**
     ...
     */
    readonly collName: pulumi.Output<string>;
    /**
     * Criteria to use for archiving data.
     */
    readonly criteria: pulumi.Output<outputs.OnlineArchiveCriteria>;
    /**
     ...
     */
    readonly partitionFields: pulumi.Output<outputs.OnlineArchivePartitionField[]>;
    /**
    ...
    readonly syncCreation: pulumi.Output<boolean | undefined>;
    /**
