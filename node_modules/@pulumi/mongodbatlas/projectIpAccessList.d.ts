...
export declare class ProjectIpAccessList extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectIpAccessListState, opts?: pulumi.CustomResourceOptions): ProjectIpAccessList;
    /**
     * Returns true if the given object is an instance of ProjectIpAccessList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectIpAccessList;
    /**
