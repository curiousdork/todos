...
export declare class X509AuthenticationDatabaseUser extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: X509AuthenticationDatabaseUserState, opts?: pulumi.CustomResourceOptions): X509AuthenticationDatabaseUser;
    /**
     ...
     */
    static isInstance(obj: any): obj is X509AuthenticationDatabaseUser;
    /**
     * Array of objects where each details one unexpired database user certificate.
     */
    readonly certificates: pulumi.Output<outputs.X509AuthenticationDatabaseUserCertificate[]>;
    /**
     * Contains the last X.509 certificate and private key created for a database user.
     */
    readonly currentCertificate: pulumi.Output<string>;
    /**
     * PEM string containing one or more customer CAs for database user authentication.
     */
    readonly customerX509Cas: pulumi.Output<string | undefined>;
    /**
     * A number of months that the created certificate is valid for before expiry, up to 24 months. By default is 3.
     */
    readonly monthsUntilExpiration: pulumi.Output<number | undefined>;
    /**
